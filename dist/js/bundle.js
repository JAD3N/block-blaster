...
var BlockBlaster = function () {
	function BlockBlaster(parameters) {
		(0, _classCallCheck3.default)(this, BlockBlaster);

		this.parameters = parameters;
		this.canvas = document.getElementById(this.parameters.canvas);
		this.renderer = new _renderer2.default(this.canvas);

		this.grid = new _grid2.default(10, 10);
		this.grid.fill();
	...
	(0, _createClass3.default)(BlockBlaster, [{
		key: "draw",
		value: function draw() {
			var _this = this;
...
exports.default = BlockBlaster;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./controller":95,"./core/grid":97,"./renderer":100,"./util/log":103,"babel-runtime/helpers/classCallCheck":8,"babel-runtime/helpers/createClass":9}],95:[function(require,module,exports){
"use strict";
...
var _colour = require("./util/colour");
...
var Controller = function () {
	function Controller(game) {
		...
		this.drag.ondragmove = function (x, y) {
			if (_this.dragging) {
				_this.dragging.x = initialPos.x + x;
				_this.dragging.y = initialPos.y + y;
				_this.snap(false);
			}
		};
		this.drag.ondragend = function () {
			_this.dragging.dragging = false;
			_this.snap(true);
			_this.dragging = null;
		};
		this.update();
	...
	(0, _createClass3.default)(Controller, [{
		...
		value: function update() {
			...
			for (var _y = 0; _y < grid.height; _y++) {
				...
				for (var _x = 0; _x < grid.width; _x++) {
					var _block = grid.get(_x, _y);
					if (!array.includes(_block)) {
						_temp.push(_block);
					}
					if (_block.empty) {
						_empty = true;
			...
			for (var x = 0; x < pattern.width; x++) {
				for (var y = 0; y < pattern.height; y++) {
					if (pattern.data[x + y * pattern.width] === 1) {
						shape.set(x, y, new _block4.default(x, y, null, false));
					}
				}
			}
			return shape;
		...
		value: function snap() {
			...
			if (this.fits(this.dragging, x, y)) {
				if (Math.abs(xDelta) <= _renderer2.default.BLOCK.snap && Math.abs(yDelta) <= _renderer2.default.BLOCK.snap) {
		...
		value: function fits(shape, x, y) {
			...
			try {
				for (var _iterator3 = (0, _getIterator3.default)(shape.blocks), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					var block = _step3.value;

					if (block) {
						var x2 = block.x + x;
						var y2 = block.y + y;
						var block2 = grid.get(x2, y2);
		...
		key: "place",
		value: function place(shape, x, y) {
			if (this.fits(shape, x, y)) {
				...
				try {
					for (var _iterator4 = (0, _getIterator3.default)(shape.blocks), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						var block = _step4.value;

						if (block) {
							var x2 = block.x + x;
							var y2 = block.y + y;
							var block2 = this.game.grid.get(x2, y2);
							block2.empty = false;
...
var Block = function Block(x, y) {
	var colour = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
},{"babel-runtime/helpers/classCallCheck":8}],97:[function(require,module,exports){
"use strict";
		...
		value: function fill() {
			for (var x = 0; x < this.width; x++) {
				for (var y = 0; y < this.height; y++) {
					this.blocks[x + y * this.width] = new _block2.default(x, y);
				}
			}
		}
	}, {
...
},{"../renderer":100,"./block":96,"babel-runtime/helpers/classCallCheck":8,"babel-runtime/helpers/createClass":9}],98:[function(require,module,exports){
"use strict";
...
var Shape = function (_Grid) {
	(0, _inherits3.default)(Shape, _Grid);

	function Shape(x, y, width, height, colour) {
		(0, _classCallCheck3.default)(this, Shape);

		var _this = (0, _possibleConstructorReturn3.default)(this, (Shape.__proto__ || (0, _getPrototypeOf2.default)(Shape)).call(this, width, height));
...
},{"./grid":97,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":8,"babel-runtime/helpers/createClass":9,"babel-runtime/helpers/inherits":10,"babel-runtime/helpers/possibleConstructorReturn":11}],100:[function(require,module,exports){
"use strict";
...
var Renderer = function () {
	...
	(0, _createClass3.default)(Renderer, [{
		...
		value: function drawShape(grid, shape) {
			...
			for (var x2 = 0; x2 < shape.width; x2++) {
				for (var y2 = 0; y2 < shape.height; y2++) {
					...
					if (block) {
						var offsets = Renderer.BLOCK.getOffsets(block);
		...
		key: "getGridPos",
		value: function getGridPos(grid) {
			var gridSize = grid.screenSize;
			var x = (this.canvas.width - gridSize.width) / 2;
			var y = (this.canvas.height - gridSize.height) / 2;
			return {
				x: x,
				y: y,
		...
		value: function drawGrid(grid) {
			...
			var x = pos.x;
			var y = pos.y;
			for (var x2 = 0; x2 < grid.width; x2++) {
				for (var y2 = 0; y2 < grid.height; y2++) {
					var block = grid.get(x2, y2);
					if (block) {
						var offsets = Renderer.BLOCK.getOffsets(block);
...
Renderer.BLOCK = {
	...
	getOffsets: function getOffsets(block) {
		...
		var x = block.x * this.size + block.x * this.margin + emptyOff;
		var y = block.y * this.size + block.y * this.margin + emptyOff;
		return { x: x, y: y };
	}
};
...
},{"./util/colour":101,"babel-runtime/helpers/classCallCheck":8,"babel-runtime/helpers/createClass":9}],101:[function(require,module,exports){
"use strict";
...
var VALUES = {};
var RANDOM = new _randomJs2.default();

var Colour = function () {
	function Colour(name, light, dark) {
		(0, _classCallCheck3.default)(this, Colour);
...
},{"babel-runtime/helpers/classCallCheck":8,"babel-runtime/helpers/createClass":9,"random-js":93}],102:[function(require,module,exports){
"use strict";
...
},{"babel-runtime/helpers/classCallCheck":8,"jquery":92}],103:[function(require,module,exports){
"use strict";
